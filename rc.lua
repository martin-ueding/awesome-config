...
beautiful.init("/home/mu/.config/awesome/themes/solarized/dark/theme.lua")
...
vicious.register(batwidget, vicious.widgets.bat, "Akku: $1 $2% <span color='white'>$3</span>", 15, "BAT0")
