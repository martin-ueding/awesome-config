...
function net_widget_function(widget, data)
    ...
    if data['{eth0 up_kb}'] ~= nil and data['{eth0 down_kb}'] ~= nil
        ...
        then
        result = result .. vicious.helpers.format('eth0: ${eth0 up_kb} ↑ ${eth0 down_kb} ↓ KiB/s', data)
        need_space = true
    end
    ...
    if data['{wlan0 up_kb}'] ~= nil and data['{wlan0 down_kb}'] ~= nil
        ...
        result = result .. vicious.helpers.format('wlan0: ${wlan0 up_kb} ↑ ${wlan0 down_kb} ↓ KiB/s', data)
    end
